...
//
//    pekostruct, err := UnmarshalPekostruct(bytes)
//    bytes, err = pekostruct.Marshal()

package pekostruct

import "encoding/json"

func UnmarshalPekostruct(data []byte) (Pekostruct, error) {
	var r Pekostruct
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *Pekostruct) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

type Pekostruct struct {
